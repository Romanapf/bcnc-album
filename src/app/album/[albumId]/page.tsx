...
const AlbumDetailPage = async ({
  ...
  return (
    <div className='grid grid-cols-12 gap-8'>
      ...
      <div className='col-span-4  rounded-lg bg-[rgba(255,255,255,0.1)] backdrop-filter backdrop-blur-lg pl-8 pr-8'>
      ...
      <div className='col-span-8 rounded-lg bg-[rgba(255,255,255,0.1)] backdrop-filter backdrop-blur-lg p-8'>
